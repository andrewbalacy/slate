...
function derivePreview(energy: number | null, cognitiveLoad: CognitiveLoad | "", workToday: YesNo | "") {
...
function SystemStatePreview({ energy, cognitiveLoad, workToday }: {
  energy: number | null;
...
function RuleExplanation({ energy, cognitiveLoad, workToday, trainingToday }: {
  energy: number | null;
  cognitiveLoad: CognitiveLoad | "";
  workToday: YesNo | "";
  trainingToday: TrainingToday | "";
...
function ProtocolCard({ energy, cognitiveLoad, workToday }: {
  energy: number | null;
  cognitiveLoad: CognitiveLoad | "";
  workToday: YesNo | "";
}) {
